...
<form action="{{ url('/pengelola/' . $pengelola->id_pemilik . '/update') }}" method="POST" id="form-edit">
    @csrf
    @method('PUT')
    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Edit Data Pengelola</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_hp" class="form-control"
                        value="{{ $pengelola->no_hp }}" required>
                    <small id="error-no_hp" class="error-text text-danger"></small>
                </div>

                <div class="form-group">
                    <label>Alamat</label>
                    <textarea name="alamat" class="form-control" required>{{ $pengelola->alamat }}</textarea>
